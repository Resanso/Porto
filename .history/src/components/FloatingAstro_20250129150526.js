...
const FloatingAstro = () => {
  ...
  return (
    <div className="relative">
      {/* Main container - make it smaller but keep the 3D model size */}
      <motion.div
        ref={containerRef}
        ...
        className="relative" // Remove fixed width/height
      >
        {/* Inner div for hover trigger */}
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32" />
      </motion.div>

      {/* Bubble Text - positioned above the astronaut */}
      <motion.div
        ...
        className="fixed z-[1000] transform -translate-y-[200px] -translate-x-[100px]"
      >
        <div className="relative">
          <div className="absolute w-3 h-3 bg-neon-cyan rotate-45 transform left-1/2 -translate-x-1/2 translate-y-[2.2rem]" />
          <div className="bg-neon-cyan text-dark-blue px-3 py-1.5 rounded-lg font-mono text-sm whitespace-nowrap shadow-lg">
