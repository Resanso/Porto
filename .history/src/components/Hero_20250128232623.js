  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        // Terapkan material transparan ke semua mesh
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
            ...
            >
              <div className="relative w-full max-w-[800px] aspect-square">
                {/* Gradient overlays */}
                <div className="absolute inset-0 bg-gradient-to-t from-dark-blue via-transparent to-dark-blue opacity-80 pointer-events-none z-10" />
                <div className="absolute inset-0 bg-gradient-to-r from-dark-blue via-transparent to-dark-blue opacity-50 pointer-events-none z-10" />
                <div
                  ref={modelRef}
