  ...
  return (
    <section className="relative min-h-screen">
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-1/4 w-32 h-32 blur-3xl bg-neon-cyan/20 rounded-full"
      />
      <motion.div
        animate={{
          y: [20, -20, 20],
        ...
        className="absolute bottom-1/4 right-1/4 w-40 h-40 blur-3xl bg-neon-purple/20 rounded-full"
      />
