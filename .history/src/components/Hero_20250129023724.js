  ...
  return (
    <section className="relative min-h-screen pt-20 lg:pt-0">
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-1/4 w-24 md:w-32 h-24 md:h-32 blur-xl bg-neon-cyan/30 rounded-full z-0"
      />
      <motion.div
        animate={{
          y: [20, -20, 20],
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[calc(100vh-80px)]">
            ...
            <motion.div
              ...
              className="text-center lg:text-left order-1 lg:pl-[10%] xl:pl-[15%]"
            >
              <motion.p className="text-neon-cyan font-mono text-sm md:text-base mb-4 md:mb-6 tracking-wider">
                Hi, my name is
              </motion.p>
              ...
              <div className="relative inline-block name-container">
                <motion.h1
                  ...
                  className="text-4xl md:text-5xl lg:text-6xl font-bold text-lightest-slate mb-2 cursor-pointer"
                >
                  Resan So
                </motion.h1>
              ...
              <div className="ticker-container text-base md:text-xl lg:text-2xl">
              ...
              <motion.p
                ...
                className="text-base md:text-lg text-slate max-w-lg mx-auto lg:mx-0 mb-6 md:mb-8 leading-relaxed" // Reduced from mb-10
              >
              ...
              >
                <button
                  ...
                  className="px-6 md:px-8 py-3 md:py-4 bg-glass-gradient border border-neon-cyan/30 text-neon-cyan 
                ...
                <button
                  ...
                  className="px-6 md:px-8 py-3 md:py-4 text-lightest-slate text-sm md:text-base font-mono rounded-lg 
