...
const FloatingAstro = () => {
  ...
  useEffect(() => {
    ...
    const ambientLight = new THREE.AmbientLight(0xffffff, 2); // Kurangi intensitas
    scene.add(ambientLight);

    const directionalLight = new THREE.DirectionalLight(0xffffff, 1); // Ganti warna ke putih
