...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    // Ubah ukuran renderer
    renderer.setSize(300, 300); // Ukuran dikurangi dari 400x400 menjadi 300x300
    ...
    loader.load(
      ...
      (gltf) => {
        head = gltf.scene;
        head.scale.set(1.5, 1.5, 1.5); // Skala dikurangi dari 2 menjadi 1.5
        scene.add(head);

        // Initial position
        camera.position.z = 4; // Kamera sedikit lebih dekat, dari 5 menjadi 4
      ...
      <div className="max-w-5xl mx-auto relative">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <motion.div
            ...
            className="relative perspective-1000 max-w-[300px] mx-auto" // Ubah max-width dari sm menjadi spesifik 300px
          >
