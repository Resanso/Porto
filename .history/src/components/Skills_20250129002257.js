...
const Skills = () => {
  ...
  const isInView = useInView(ref, { once: true }); // Set once: true agar hanya trigger sekali
  ...
  // Memicu animasi hanya jika belum pernah dianimasikan dan sedang dalam view
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 relative">
        <motion.h2
          ...
          className="text-5xl font-mono text-light-slate mb-16 text-center"
        >
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-3 gap-12 max-w-4xl mx-auto"
        >
