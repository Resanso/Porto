  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-4 relative">
        ...
        <div
          ref={carouselRef}
          className="flex md:grid md:grid-cols-2 gap-4 sm:gap-8 max-w-5xl mx-auto overflow-x-auto snap-x snap-mandatory scrollbar-hide"
          style={{
            scrollbarWidth: "none",
        ...
        >
          {skillCategories.map((category, index) => (
            <div
              key={index}
              className="min-w-full md:min-w-0 snap-start px-2 sm:px-4 md:px-0"
            >
              <SkillCard
