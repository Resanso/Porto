        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 items-center max-w-full mx-auto">
            ...
            <motion.div
              ...
              className="text-center lg:text-left order-2 lg:order-1 lg:pl-[15%]"
            >
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <div className="relative inline-block name-container">
                <motion.h1
                  ...
                  className="text-5xl lg:text-6xl font-bold text-lightest-slate mb-2 cursor-pointer"
                >
                  Resan So
                </motion.h1>

                {/* Social Media Card */}
                <div className="social-card absolute left-1/2 transform -translate-x-1/2 mt-2 p-4 bg-navy-light rounded-lg shadow-xl border border-navy-lighter/50 backdrop-blur-sm">
                  <div className="flex gap-4">
                    <a
                      href="https://www.instagram.com/YourInstagram"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="social-link flex items-center gap-2 text-light-slate hover:text-neon-cyan px-4 py-2 rounded-md bg-glass"
                    >
