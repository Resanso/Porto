...
const FloatingAstro = () => {
  ...
  useEffect(() => {
    ...
    const ambientLight = new THREE.AmbientLight(0xffffff, 50); // Reduced intensity
    scene.add(ambientLight);

    const directionalLight = new THREE.DirectionalLight(0xffffff, 59); // Ganti warna ke putih
