  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        model.position.set(0, -15, 0); // Geser ke atas dengan memindahkan posisi Y ke bawah
        scene.add(model);

        // Sesuaikan posisi kamera untuk fokus ke bagian atas
        camera.position.z = 4;
        camera.position.y = 2; // Arahkan kamera sedikit ke atas
        camera.lookAt(0, 0, 0);
      ...
      <div className="max-w-5xl mx-auto relative">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <div
              ref={modelRef}
              className="relative w-[400px] h-[400px]" // Perbesar container
              style={{
