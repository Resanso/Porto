...
import ParallaxSection from "./ParallaxSection"; // Add this import
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
            ...
            <Parallax translateY={[0, -20]} opacity={[1, 0.8]}>
              <motion.div className="text-center lg:text-left order-2 lg:order-1">
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
            ...
            <Parallax translateY={[20, -20]} opacity={[1, 0.8]}>
