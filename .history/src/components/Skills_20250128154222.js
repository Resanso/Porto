      ...
      <div className="card-glass relative p-8 rounded-lg backdrop-blur-sm border border-white/10">
        ...
        <div className="flex justify-center mb-6">
          ...
          >
            {/* Glow rings */}
            <div
              className="absolute inset-0 animate-ping-slow opacity-20 scale-[1.8] group-hover:scale-[0]"
              style={{ color: skill.color }}
            >
              <skill.icon className="w-12 h-12" />
            </div>
            <div
              className="absolute inset-0 animate-pulse opacity-40 scale-[1.5] group-hover:scale-[1]"
              style={{ color: skill.color }}
            >
              <skill.icon className="w-12 h-12" />
            </div>
