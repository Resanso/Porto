  ...
  return (
    <div className="relative">
      <motion.div
        ...
        className="w-[400px] h-[400px]" // Removed pointer-events-none
      />
      ...
      <motion.div
        ...
        className="fixed z-[1000] transform -translate-y-32" // Adjusted positioning
      >
        <div className="relative">
          <div className="absolute w-4 h-4 bg-neon-cyan rotate-45 transform left-1/2 -translate-x-2 translate-y-[2.4rem]" />
          <div className="bg-neon-cyan text-dark-blue px-4 py-2 rounded-lg font-mono text-sm whitespace-nowrap shadow-lg">
