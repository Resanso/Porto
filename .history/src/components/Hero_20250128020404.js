...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    loader.load(
      "/orangeBot.glb", // Pastikan file ada di folder public
      (gltf) => {
        ...
        head.position.x = -center.x;
        head.position.y = -center.y;
        head.position.z = -center.z;
    ...
    return () => {
      ...
      if (modelRef.current && renderer.domElement) {
