      ...
      <div className="card-glass relative p-8 rounded-lg backdrop-blur-sm border border-white/10">
        ...
        <div className="flex justify-center mb-6">
          ...
          >
            {/* Glow rings */}
            <div
              className="absolute inset-0 animate-ping-slow opacity-20 scale-[1.5] group-hover:scale-[1.5]"
              style={{ color: skill.color }}
            >
              <skill.icon className="w-12 h-12" />
            </div>
            <div
              className="absolute inset-0 animate-pulse opacity-40 scale-[1.5] group-hover:scale-[1.5]"
              style={{ color: skill.color }}
            >
              <skill.icon className="w-12 h-12" />
            </div>
            {/* Main icon */}
            <skill.icon
              className="w-12 h-12 relative z-10 transition-all duration-300 group-hover:scale-130"
              style={{ color: skill.color }}
            />
          </motion.div>
        </div>
