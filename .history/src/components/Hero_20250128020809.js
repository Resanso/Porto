...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    // Lighting
    const ambientLight = new THREE.AmbientLight(0xffffff, 1); // Tingkatkan intensitas
    scene.add(ambientLight);

    const directionalLight = new THREE.DirectionalLight(0x64ffda, 2); // Tingkatkan intensitas
    directionalLight.position.set(2, 2, 2);
    scene.add(directionalLight);

    // Tambahkan hemisphere light
