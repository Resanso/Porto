      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 items-center max-w-full mx-auto">
            ...
            >
              <motion.p className="text-neon-cyan font-mono text-base mb-6 tracking-wider">
                Hi, my name is
              </motion.p>
              ...
              <div className="relative inline-block name-container">
                ...
                <div className="social-card p-3 bg-navy-light rounded-lg shadow-xl border border-navy-lighter/50 backdrop-blur-sm">
