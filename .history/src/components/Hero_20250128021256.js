...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (gltf) => {
        head = gltf.scene;
        head.scale.set(1, 1, 1); // Skala dikurangi menjadi 1
        scene.add(head);

        camera.position.z = 3; // Kamera lebih dekat
      ...
      <div className="max-w-5xl mx-auto relative">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            {/* 3D Model Container - tanpa batasan ukuran dan background */}
