  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        model.position.set(0, -35, 0); // Sesuaikan posisi agar lebih pas di tengah
        scene.add(model);

        // Sesuaikan posisi kamera untuk fokus ke bagian atas
        camera.position.z = 6; // Mundurkan kamera
      ...
      <div className="max-w-5xl mx-auto relative">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <div
              ref={modelRef}
              className="relative w-[600px] h-[600px]" // Perbesar container
              style={{
                transform: "scale(1.2)", // Skala tambahan untuk container
                transformOrigin: "center center",
                filter: "drop-shadow(0 0 30px rgba(100, 255, 218, 0.15))", // Sesuaikan glow effect
              }}
            />
          </motion.div>
        </div>
