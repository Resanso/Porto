...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen pt-16 md:pt-20 lg:pt-0 px-4 md:px-6">
      ...
      <motion.div
        ...
        className="absolute top-20 md:top-1/4 left-1/4 w-20 md:w-32 h-20 md:h-32 blur-xl bg-neon-cyan/20 rounded-full z-0"
      />
      <motion.div
        animate={{
          y: [20, -20, 20],
        ...
        className="absolute bottom-1/3 md:bottom-1/4 right-1/4 w-24 md:w-40 h-24 md:h-40 blur-xl bg-neon-purple/20 rounded-full z-0"
      />
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 items-center min-h-[calc(100vh-64px)]">
            {/* Text Content - removed max-w-xl constraint */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="text-center lg:text-left w-full max-w-2xl mx-auto lg:mx-0 lg:pl-[10%] xl:pl-[15%] space-y-4 md:space-y-6"
            >
              <motion.p className="text-neon-cyan font-mono text-sm md:text-base tracking-wider">
                Hi, my name is
              </motion.p>

              <div className="relative inline-block name-container mb-2 md:mb-4">
                <motion.h1
                ...
                <div className="social-card p-2 md:p-3 bg-navy-light rounded-lg shadow-xl border border-navy-lighter/50 backdrop-blur-sm">
              ...
              <div className="ticker-container h-8 md:h-10 my-2 md:my-4">
              ...
              <motion.p
                ...
                className="text-sm md:text-base lg:text-lg text-slate max-w-lg mx-auto lg:mx-0 leading-relaxed"
              >
              ...
              <motion.div
                ...
                className="flex flex-col sm:flex-row gap-3 sm:gap-6 justify-center lg:justify-start mt-6 md:mt-8"
              >
                <button
                  onClick={() => scrollToSection("projects")}
                  className="w-full sm:w-auto px-6 py-3 md:px-8 md:py-4 bg-glass-gradient border border-neon-cyan/30 text-neon-cyan 
                    text-sm md:text-base font-mono rounded-lg hover:bg-neon-cyan/10 transition-all duration-300"
                >
                  View My Work
                </button>
                <button
                  onClick={() => scrollToSection("contact")}
                  className="w-full sm:w-auto px-6 py-3 md:px-8 md:py-4 text-lightest-slate text-sm md:text-base font-mono rounded-lg 
