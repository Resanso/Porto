      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
            ...
            {/* 3D Model Container - Added gradient wrapper */}
            <motion.div
            ...
            >
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute inset-0 bg-gradient-radial from-transparent via-transparent to-dark-blue opacity-100" />
                <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-dark-blue via-dark-blue/80 to-transparent" />
                <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-dark-blue via-dark-blue/80 to-transparent" />
                <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-dark-blue via-dark-blue/80 to-transparent" />
                <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-dark-blue via-dark-blue/80 to-transparent" />
              </div>
              <div
                ref={modelRef}
