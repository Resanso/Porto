    ...
    <section className="relative min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4">
          {/* Remove max-width constraint and adjust grid gap */}
          <div className="grid lg:grid-cols-2 gap-4 items-center">
            ...
            <motion.div
              ...
              className="text-center lg:text-left order-2 lg:order-1 max-w-xl"
            >
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            {/* 3D Model Container - Adjusted to extend fully to the right */}
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.7, duration: 0.8 }}
              className="relative order-1 lg:order-2 w-full flex justify-end items-center"
            >
              <div
                ref={modelRef}
