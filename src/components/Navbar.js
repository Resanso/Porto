  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 flex justify-between items-center">
        ...
        >
          <div
            className="absolute -inset-2 bg-gradient-to-r from-neon-cyan to-neon-purple 
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          >
            ...
            <div
              className="absolute inset-0 bg-neon-cyan/20 translate-y-full 
              group-hover:translate-y-0 transition-transform duration-300"
            />

            {/* Button text */}
            <span
              className="relative font-mono text-sm text-neon-cyan 
